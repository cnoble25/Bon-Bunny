...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            actionOverRideProperty = serializedObject.FindProperty("OverRideAction");
            actionOverRideStringProperty = serializedObject.FindProperty("actionLabelString");
        ...
        public override void OnInspectorGUI()
        {
            ...
            //CustomShit
            EditorGUILayout.Space();
            EditorGUILayout.LabelField(CustomizeUILabel, Styles.boldLabel);
            using (new EditorGUI.IndentLevelScope())
            {
                EditorGUILayout.PropertyField(actionOverRideProperty);
                EditorGUILayout.PropertyField(actionOverRideStringProperty);
        ...
        private SerializedProperty actionOverRideProperty;
        private SerializedProperty actionOverRideStringProperty;
        ...
        private GUIContent CustomizeUILabel = new GUIContent("Customize UI");
